...
import 'package:business_sahaj_erp/data/local/collections/purchase_item_collection.g.dart';
import 'package:business_sahaj_erp/data/local/collections/invoice_item_collection.g.dart';
import 'package:business_sahaj_erp/data/local/collections/stock_adjustment_collection.g.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Bottom row: Price + Stock Value + Stock badge
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Column(
