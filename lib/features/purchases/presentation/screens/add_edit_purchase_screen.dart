              ...
              children: [
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(labelText: 'Paid Amount (₹)', border: (ref.watch(themeProvider).themeType == ThemeType.neumorphism) ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none) : const OutlineInputBorder(),),
                    onChanged: (val) {
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: InputDecorator(
                      decoration: InputDecoration(labelText: 'Due Date', border: (ref.watch(themeProvider).themeType == ThemeType.neumorphism) ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none) : const OutlineInputBorder(),),
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: InputDecorator(
                      decoration: InputDecoration(labelText: 'Purchase Date', border: (ref.watch(themeProvider).themeType == ThemeType.neumorphism) ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none) : const OutlineInputBorder(), isDense: true),
