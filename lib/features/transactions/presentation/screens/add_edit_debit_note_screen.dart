                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: InputDecorator(
                      decoration: InputDecoration(labelText: 'DebitNote Date', border: (ref.watch(themeProvider).themeType == ThemeType.neumorphism) ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none) : const OutlineInputBorder(), isDense: true),
